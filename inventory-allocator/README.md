...
Implemented a class in src/inventoryAllocator.js which has a function that takes in an order and warehouses and calculates the cheapest shipment.
Written several test cases in /test/index.test.js to demonstrate the functionality of the code
